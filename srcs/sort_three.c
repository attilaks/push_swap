...
/*   Updated: 2019/02/19 21:37:47 by jwillem-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	one_three_two(t_stack *stk, int *rotate)
{
		ps_rotate(stk, "ra", 1);
		ps_swap(stk, "sa", 1);
		*rotate--;
...
void	two_three_one(t_stack *stk, int *rotate)
{
	ps_push_b(stk, 1);
	ps_swap(stk, "sa", 1);
	ps_rotate(stk, "ra", 1);
...
void	three_one_two(t_stack *stk, int *rotate)
{
	ps_swap(stk, "sa", 1);
	ps_rotate(stk, "ra", 1);
	ps_swap(stk, "sa", 1);
...
void	three_two_one(t_stack *stk, int *rotate)
{
	ps_push_b(stk, 1);
	ps_swap(stk, "sa", 1);
	ps_rotate(stk, "ra", 1);
